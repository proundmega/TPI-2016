...
public class PersonalEspecialidadFacade extends AbstractFacade<PersonalEspecialidad> implements PersonalEspecialidadFacadeLocal {
    ...
    @Override
    public void create(PersonalEspecialidad personalEspecialidad) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void edit(PersonalEspecialidad personalEspecialidad) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void remove(PersonalEspecialidad personalEspecialidad) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
