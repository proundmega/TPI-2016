...
namespace ParcialTPI.vistas.Mapeo
{
    ...
    public class IngresoDetalleExamen : SuperToString
    {
        public DateTime fechaRealizacion { get; set; }
        public DateTime fechaOrden { get; set; }
        public DateTime horaRealizacion { get; set; }
        public int? idIngresoDetalleExamen { get; set; }
        public Examen idExamen { get; set; }
        public IngresoDetalle ingresoDetalle { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            var ide = (IngresoDetalleExamen)obj;
            return this.idIngresoDetalleExamen.Equals(ide.idIngresoDetalleExamen);
        }
    }

    public class Examen : SuperToString
    {
        ...
        public String observaciones { get; set; }
        public TipoExamen idTipoExamen { get; set; }
    }

    public class TipoExamen : SuperToString
    {
