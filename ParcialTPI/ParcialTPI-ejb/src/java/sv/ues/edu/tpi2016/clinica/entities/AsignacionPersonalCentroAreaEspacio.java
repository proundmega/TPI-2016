 ...
 */
@Entity
@Table(name = "asignacion_personal_centro_area_espacio")
@XmlRootElement
@NamedQueries({
...
public class AsignacionPersonalCentroAreaEspacio implements Serializable {
    ...
    public String toString() {
        return "www.ues.edu.sv.local.entities.AsignacionPersonalCentroAreaEspacio[ asignacionPersonalCentroAreaEspacioPK=" + asignacionPersonalCentroAreaEspacioPK + " ]";
    }
