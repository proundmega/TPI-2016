 ...
 */
@Entity
@Table(name = "ingreso_detalle_diagnostico")
@XmlRootElement
@NamedQueries({
...
public class IngresoDetalleDiagnostico implements Serializable {
    ...
    @Column(name = "id_ingreso_detalle_diagnostico")
    ...
    public String toString() {
        return "www.ues.edu.sv.local.entities.IngresoDetalleDiagnostico[ idIngresoDetalleDiagnostico=" + idIngresoDetalleDiagnostico + " ]";
    }
