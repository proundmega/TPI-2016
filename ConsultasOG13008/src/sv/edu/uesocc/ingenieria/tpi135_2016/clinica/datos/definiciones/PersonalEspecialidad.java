 ...
 */
@Entity
@Table(name = "personal_especialidad", catalog = "clinica", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class PersonalEspecialidad implements Serializable {
    ...
    public String toString() {
        return "sv.proundmega.clinica.entities.PersonalEspecialidad[ personalEspecialidadPK=" + personalEspecialidadPK + " ]";
    }
