 ...
 */
@Entity
@Table(name = "ingreso_detalle_examen", catalog = "clinica", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class IngresoDetalleExamen implements Serializable {
    ...
    @Column(name = "id_ingreso_detalle_examen", nullable = false)
    ...
    public String toString() {
        return "sv.proundmega.clinica.entities.IngresoDetalleExamen[ idIngresoDetalleExamen=" + idIngresoDetalleExamen + " ]";
    }
