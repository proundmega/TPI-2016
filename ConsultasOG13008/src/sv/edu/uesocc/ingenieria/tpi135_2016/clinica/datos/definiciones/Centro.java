 ...
 */
@Entity
@Table(name = "centro", catalog = "clinica", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class Centro implements Serializable {
    ...
    @Column(name = "nombre_corto", length = 155)
    private String nombreCorto;
    @Column(name = "nombre_oficial", length = 255)
    ...
    public String toString() {
        return "sv.proundmega.clinica.entities.Centro[ idCentro=" + idCentro + " ]";
    }
